...
public class RespostaInativacaoChavePixDTO {
    private UUID id;
    ...
    public RespostaInativacaoChavePixDTO(EntidadeChavePix chavePix) {
        ...
        this.dataHoraInativacaoChave = chavePix.getDataHoraInativacaoChave();
        this.ativa = chavePix.isAtiva();
    }
